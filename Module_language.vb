...
Module Module_Language
    Public Sub to_en()
        ...
        form_main.合并比对ToolStripMenuItem.Text = "Merge && Trim (trimAl)"
        ...
        form_main.合并参考序列ToolStripMenuItem.Text = "Merge reference sequences"
        form_main.按物种合并ToolStripMenuItem.Text = "Merge by species"
        form_main.合并文件ToolStripMenuItem.Text = "Merge files directly"
