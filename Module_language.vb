...
Module Module_Language
    Public Sub to_en()
        ...
        form_main.导出ToolStripMenuItem.Text = "Export Current List"
        ...
        form_main.合并结果ToolStripMenuItem.Text = "Combine Results"
        form_main.合并比对ToolStripMenuItem.Text = "Combine && Trim (trimAl)"
        ...
        form_config_tree.RadioButton4.Text = "Use Trimmed Data Matrix"
        form_config_tree.RadioButton3.Text = "Use Original Data Matrix"
        ...
        form_config_mcmc.Label4.Text = "Clean Data"
    ...
    Public Sub to_ch()
        ...
        form_main.导出ToolStripMenuItem.Text = "导出当前列表"
        ...
        form_main.合并比对ToolStripMenuItem.Text = "合并&&切齐(trimAl)"
